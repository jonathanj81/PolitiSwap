...
import com.politiswap.politiswap.DialogFragments.BillDialogFragment;
...
public class LegislationAdapter extends RecyclerView.Adapter<LegislationAdapter.LegislationViewHolder> {
    ...
    private List<com.politiswap.politiswap.DataUtils.Searched.Bill> mSearchedBills = new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull LegislationViewHolder holder, int i) {
        ...
        if (mType == 0) {
            ...
            com.politiswap.politiswap.DataUtils.Searched.Bill bill = mSearchedBills.get(i);
            slug = bill.getNumber();
            date = bill.getIntroducedDate();
            subject = bill.getPrimarySubject();
            title = bill.getTitle();
    ...
    public void setRefreshedSearchedBills(List<com.politiswap.politiswap.DataUtils.Searched.Bill> bills){
    ...
    public List<com.politiswap.politiswap.DataUtils.Searched.Bill> getSearchedBills(){
    ...
    private class BillComparator implements Comparator<com.politiswap.politiswap.DataUtils.Searched.Bill>{

        @Override
        public int compare(com.politiswap.politiswap.DataUtils.Searched.Bill billA, com.politiswap.politiswap.DataUtils.Searched.Bill billB) {
